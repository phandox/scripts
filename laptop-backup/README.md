...
* backup should be encrypted and incremental (using Borg backup for this)
* there should be an easy way to extend backup script to save files in network / cloud storage (again, Borg will do this with another repository. As offsite backup, [rsync.net](http://rsync.net) seems viable)
